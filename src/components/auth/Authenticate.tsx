...
const Authenticate = ({signindata,setsignindata}:{signindata:any,setsignindata:(data:any)=>void}) => {
  ...
  return (
    <div className=' flex flex-col gap-5 items-center'>
        {
            signindata?.secretkeyexist && <h1 className=' font-bold text-2xl'>{signindata?.username}</h1>
        }
        ...
        <div className=' flex flex-col gap-5 p-4 rounded-md bg-secondary items-center'>
            ...
            {
                signindata?.secretkeyexist ?<p className=' text-center'>Enter the code generated by your authenticator app.</p>:<>
